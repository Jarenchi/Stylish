...
const Swiper: React.FC = () => {
  ...
  const autoPlayTimeoutRef: React.MutableRefObject<NodeJS.Timeout | undefined> = useRef<NodeJS.Timeout | undefined>(
    undefined,
  );
  ...
  return (
    <div className="relative" onMouseEnter={handleDotMouseEnter} onMouseLeave={handleDotMouseLeave}>
      <img
